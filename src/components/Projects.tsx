...
const Projects: React.FC = () => {
  const projects = [
    ...
    },
    {
      ...
      description: 'A data visualization dashboard that displays weather patterns and predictions using machine learning algorithms.',
    ...
    },
    {
      ...
      description: 'A Twitter-like social media platform with real-time messaging, image uploads, and social interactions.',
    ...
    },
    {
      ...
      description: 'An AI-powered tool that analyzes code quality, suggests improvements, and identifies potential bugs using machine learning.',
    ...
    },
    {
      ...
      description: 'A secure and transparent voting system built on blockchain technology ensuring vote integrity and anonymity.',
